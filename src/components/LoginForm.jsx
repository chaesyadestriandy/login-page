  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <h4 className="text-center text-sm p">
        ...
        <button
          ...
          className="w-full flex items-center justify-center bg-white border py-2 rounded-lg shadow-md hover:bg-gray-100"
        >
          <img
        ...
        <div className="text-center mt-3 text-gray-600 text-sm">
          Belum punya akun?{" "}
          <span className="text-blue-600 cursor-pointer">Daftar disini</span>
        </div>
      </div>
    </div>
  );
